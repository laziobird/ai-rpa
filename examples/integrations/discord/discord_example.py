...
7. Write e.g. "/bu whats the weather in Tokyo?" to start a browser-user task and get a response inside the Discord channel.
"""
...
bot = DiscordBot(
	...
	prefix='$bu',  # optional; prefix of messages to trigger browser-user, defaults to "$bu"
