...
Example 1: Using OpenAI (default), with default task: 'go to reddit and search for posts about browser-user'
python command_line.py

Example 2: Using OpenAI with a Custom Query
python command_line.py --query "go to google and search for browser-user"
...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        default='go to reddit and search for posts about browser-user'
    )
    parser.add_argument(
        '--provider',
        type=str,
